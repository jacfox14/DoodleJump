 ...
 * Description: test function for player movement, utilizies *
 *				movementInput function from Events-Actions-	 *
 *				Class.hpp									 *
 * Input parameters:									     *
 * Returns:													 *
 *************************************************************/
 ...
 * Date Created: 04/22/2024                                  *
 * Date Last Modified: 04/23/2024                            *
 * Description: test function for player falling to death,	 *
 *				utilizies endGame function from Events-		 *
 *				Actions-Class.hpp							 *
 * Input parameters:									     *
 * Returns:													 *
 *************************************************************/
 ...
 * Date Created: 04/22/2024                                  *
 * Date Last Modified: 04/23/2024                            *
 * Description: test function for player dying to alien,	 *
 *				utilizies deathByAlien function from Events- *
 *				Actions-Class.hpp							 *
 * Input parameters:									     *
 * Returns:													 *
 *************************************************************/
 ...
 * Date Created: 04/22/2024                                  *
 * Date Last Modified: 04/23/2024                            *
 * Description: test function for player colliding with		 *
 *				platform, utilizies endGame function from	 *
 *				Events-Actions-Class.hpp					 *
 * Input parameters:									     *
 * Returns:													 *
 *************************************************************/
